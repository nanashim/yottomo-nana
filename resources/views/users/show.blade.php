    ...
    <div class="row">
        ...
        <div class="col-xs-10">
            @if (Auth::id() == $user->id)
                ...
                <li role="presentation" class="{{ Request::is('users/*/futures') ? 'active' : '' }}"><a href="{{ route('users.futurings', ['id' => $user->id]) }}">ズッ友になるかも<span class="badge">{{ $count_futurings }}</span></a></li>
